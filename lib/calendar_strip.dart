...
import './calendar_strip_date_utils.dart';
...
class CalendarStripState extends State<CalendarStrip>
  ...
  CalendarStripState(
    ...
    lastDayOfMonth = CalendarStripDateUtils.getLastDayOfMonth(currentDate);
  ...
  int getLastDayOfMonth(rowStartingDay) {
    return CalendarStripDateUtils.getLastDayOfMonth(
